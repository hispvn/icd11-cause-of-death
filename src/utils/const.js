...
const analyticData = {
  ...
  page2: {
    2.1: "/api/analytics/events/aggregate/ogrOUKoSaWA.json?dimension=[ATTRIBUTE_SEX]&dimension=[ATTRIBUTE_AGE]-bHqcKIS01OI&filter=ou:[ORG]&filter=zwFVJMwggaH:IN:[CAUSE_GROUP_CODE]&filter=pe:[YEAR]&stage=WlWJt4lVSWw",
    2.2: "/api/analytics/events/aggregate/ogrOUKoSaWA.json?dimension=[ATTRIBUTE_SEX]&dimension=[ATTRIBUTE_AGE]-bHqcKIS01OI&filter=ou:[ORG]&filter=zwFVJMwggaH:IN:[CAUSE_GROUP_CODE]&filter=pe:[YEAR]&stage=WlWJt4lVSWw"
  },
  page3: {
  ...
  page6: {
    6.1: "/api/analytics/events/aggregate/ogrOUKoSaWA.json?dimension=[ATTRIBUTE_SEX]&dimension=[ATTRIBUTE_AGE]-S0CP6RzDx4c&filter=ou:[ORG]&filter=pe:[YEAR]&filter=zwFVJMwggaH:IN:0200&stage=WlWJt4lVSWw",
    6.2: "no_data",
